...
<head>
    ...
    <title>Sistem Pendukung Keputusan UPZ SMI</title>
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                            ...
                            <p class="text-white">Sistem Pendukung Keputusan Penerima Zakat</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <form role="form">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="/dashboard" class="btn btn-primary my-4">Buka Dashboard</a>
                                </div>
                            </form>
                        </div>
                    </div>
